...
module.exports = function(app) {
    ...
    router.post("/api/places_of_interest", function (req, res) {
        place.createPlacesWhere(
            ...
            [req.body.user_id, req.body.city, req.body.state, req.body.country, req.body.lat, req.body.lng, req.body.category, req.body.recommendation], 
            function(result) {
            res.json({ id: result.insertId });
            }
        );
